...
@section('content')
  <section class="pt-16 pb-12 bg-white min-h-screen">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {{-- Search & Filter --}}
       {{-- Form Filter --}}
        <form id="filterForm" action="{{ route('product.index') }}" method="GET" class="rounded-lg mb-8">
...
<script>
    ...
    // Fungsi menampilkan popup loading
    ...
    // Tutup popup loading ketika halaman selesai dimuat ulang
    ...
    // Event untuk search (debounce 1 detik)
